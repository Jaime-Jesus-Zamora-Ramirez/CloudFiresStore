...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  @NonNull
  public final EditText textEmailLogin;

  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull Button buttonLogin,
      @NonNull EditText editTextPasswordLogin, @NonNull EditText textEmailLogin) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      EditText textEmailLogin = ViewBindings.findChildViewById(rootView, id);
      if (textEmailLogin == null) {
        break missingId;
      }

      return new ActivityLoginBinding((ConstraintLayout) rootView, buttonLogin,
          editTextPasswordLogin, textEmailLogin);
    }
